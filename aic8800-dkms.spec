...
* Sat Mar 14 2026 Dennis Gilmore <dennis@gilmore.net.au> - 2.1.2-1
- Silence operational noise: gate verbose prints behind LOGINFO;
  set DBG_LEVEL=0 in txrxif headers to suppress sdio_dbg spam

* Sat Mar 14 2026 Dennis Gilmore <dennis@gilmore.net.au> - 2.1.1-1
- Default debug log level to LOGERROR only (suppress INFO/DEBUG/TRACE/FW noise)

* Fri Mar 13 2026 Dennis Gilmore <dennis@gilmore.net.au> - 2.1.0-1
- Add PCIe driver support (aic8800-pcie-dkms subpackage)
- Add PCIe firmware to aic8800-firmware
- Drop pre-6.1 kernel compat shims from PCIe driver

* Mon Mar 09 2026 Dennis Gilmore <dennis@gilmore.net.au> - 2.0.1-1
...
* Mon Mar 09 2026 Dennis Gilmore <dennis@gilmore.net.au> - 2.0.0-2
- Fix in_irq() removal in kernel 6.19 (use in_hardirq())

* Sun Mar 08 2026 Dennis Gilmore <dennis@gilmore.net.au> - 2.0.0-1
...
* Sun Mar 08 2026 Dennis Gilmore <dennis@gilmore.net.au> - 1.0.0-1
