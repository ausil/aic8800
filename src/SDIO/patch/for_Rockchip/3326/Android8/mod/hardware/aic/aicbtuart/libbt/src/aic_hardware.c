...
#define HCI_VSC_PCM_PARAM_SET                   HCI_VSC_UPDATE_CONFIG_INFO_CMD//FOR AIC SET PCM PARAM
...
#define HCI_VSC_PCM_PARAM_SET_SIZE              HCI_VSC_UPDATE_CONFIG_INFO_SIZE
...
uint8_t hw_config_set_pcm_param(HC_BT_HDR *p_buf){
    ...
    if (p_buf) {
        ...
        *p++ = HCI_VSC_PCM_PARAM_SET_SIZE;
        ...
        ALOGI("PCM data setting {0x%02x, 0x%02x, 0x%02x, 0x%02x, 0x%02x, 0x%02x, 0x%02x}",
