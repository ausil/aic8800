...
#undef BT_ERR
#ifdef BT_SLEEP_DBG
#define BT_DBG(fmt, arg...) printk("[BT_LPM] %s: " fmt "\n",\
				__func__, ## arg)
#else
#define BT_DBG(fmt, arg...)
#endif
#define BT_ERR(fmt, arg...) printk("[BT_LPM] %s: " fmt "\n",\
				__func__, ## arg)
...
#elif CONFIG_PLATFORM_AMLOGIC
	ret = gpio_request_one(bsi->host_wake, GPIOF_IN, "bt_hostwake");
#endif
#ifdef CONFIG_PLATFORM_ALLWINNER
...
#elif CONFIG_PLATFORM_AMLOGIC
	ret = devm_gpio_request(dev, bsi->ext_wake, "bt_ext_wake");
#endif
