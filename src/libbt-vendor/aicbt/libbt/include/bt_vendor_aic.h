...
#define LOGINFO			0x02
#define LOGTRACE		0x04
#define LOGDEBUG		0x08
#define LOGDATA			0x10
#define LOGFW			0x20


#ifndef AICBT_DBG_LEVEL
#define AICBT_DBG_LEVEL (LOGERROR|LOGINFO)
#endif

#define AICBT_LOG		"AICBTDBG("

extern int aicbt_dbg_level;

#define AICBTDBG(level, args, arg...)	\
do {	\
	if (aicbt_dbg_level & level) {	\
		ALOGI(AICBT_LOG#level")\t" args, ##arg); \
	}	\
} while (0)
...
#ifndef ASSERT_RESUME
#define ASSERT_RESUME             FALSE
#endif
