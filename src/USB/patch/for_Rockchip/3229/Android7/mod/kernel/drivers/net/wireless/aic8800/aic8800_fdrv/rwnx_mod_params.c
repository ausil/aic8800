...
#if 1
static struct ieee80211_regdomain world_regdom = {
    .n_reg_rules = 2,
    .alpha2 = "00",
    .reg_rules = {
...
static struct ieee80211_regdomain world_regdom = {
	...
	.reg_rules = {
		...
		REG_RULE(5500 - 10, 5720 + 10, 80, 6, 20,
			NL80211_RRF_DFS),
...
struct ieee80211_regdomain regdom_cn = {
	.n_reg_rules = 4,
	.alpha2 = "CN",
	.reg_rules = {
...
struct ieee80211_regdomain regdom_us01 = {
	.n_reg_rules = 6,
	.alpha2 = "US",
	.reg_rules = {
	/* channels 1..11 */
	RWNX_REG_RULE(2412-10, 2462+10, 40, 0),
	/* channels 36..48 */
	RWNX_REG_RULE(5180-10, 5240+10, 40, 0),
	/* channels 56..64 */
	RWNX_REG_RULE(5260-10, 5320+10, 40, NL80211_RRF_DFS),
	/* channels 100..118 */
	RWNX_REG_RULE(5500-10, 5590+10, 40, NL80211_RRF_DFS),
	/* channels 132..140 */
	RWNX_REG_RULE(5660-10, 5700+10, 40, NL80211_RRF_DFS),
	/* channels 149..165 */
	RWNX_REG_RULE(5745-10, 5825+10, 40, 0) }
};

struct ieee80211_regdomain regdom_us = {
	.n_reg_rules = 5,
	.alpha2 = "US",
	...
	RWNX_REG_RULE(2412-10, 2462+10, 40, 0),
	/* channels 36..48 */
	RWNX_REG_RULE(5180-10, 5240+10, 80, NL80211_RRF_AUTO_BW),
	/* channels 52..64 */
	RWNX_REG_RULE(5260-10, 5320+10, 80, NL80211_RRF_DFS | NL80211_RRF_AUTO_BW),
	/* channels 100..140 */
	RWNX_REG_RULE(5500-10, 5720+10, 80, NL80211_RRF_DFS),
	/* channels 149..165 */
	RWNX_REG_RULE(5745-10, 5825+10, 80, 0) }
};



struct ieee80211_regdomain regdom_cz_nl = {
	.n_reg_rules = 4,
	.alpha2 = "CZ",
	.reg_rules = {
	/* channels 1..13 */
	RWNX_REG_RULE(2390-10, 2510+10, 40, 0),
	/* channels 36..48 */
	RWNX_REG_RULE(5180-10, 5240+10, 80, 0),
	/* channels 52..64 */
	RWNX_REG_RULE(5260-10, 5320+10, 80, NL80211_RRF_DFS),
	/* channels 100..140 */
	RWNX_REG_RULE(5500-10, 5700+10, 80, NL80211_RRF_DFS) }
};

struct ieee80211_regdomain regdom_jp = {
	.n_reg_rules = 7,
	.alpha2 = "JP",
	.dfs_region = NL80211_DFS_JP,
	.reg_rules = {
	/* channels 1..13 */
	RWNX_REG_RULE(2412-10, 2472+10, 40, 0),
	/* channels 14 */
	RWNX_REG_RULE(2484-10, 2484+10, 20, NL80211_RRF_NO_OFDM),
	/* channels 184..196 */
	RWNX_REG_RULE(4920-10, 4980+10, 40, 0),
	/* channels 8..16 */
	RWNX_REG_RULE(5040-10, 5080+10, 40, 0),
	/* channels 36..48 */
	RWNX_REG_RULE(5180-10, 5240+10, 80, NL80211_RRF_AUTO_BW),
	/* channels 52..64 */
	RWNX_REG_RULE(5260-10, 5320+10, 80, NL80211_RRF_DFS | NL80211_RRF_AUTO_BW),
...
struct ieee80211_regdomain regdom_tr = {
	.n_reg_rules = 4,
	.alpha2 = "TR",
...
struct rwnx_regdomain rwnx_regdom_00 = {
	.country_code = "00",
	.prRegdRules = &world_regdom
};

struct rwnx_regdomain rwnx_regdom_us01 = {
	.country_code = "US01",
	.prRegdRules = &regdom_us01
};

struct rwnx_regdomain rwnx_regdom_us = {
	.country_code = "US",
	.prRegdRules = &regdom_us
};

struct rwnx_regdomain rwnx_regdom_cn = {
	.country_code = "CN",
	.prRegdRules = &regdom_cn
};

struct rwnx_regdomain rwnx_regdom_nl = {
	.country_code = "NL",
	.prRegdRules = &regdom_cz_nl
};

struct rwnx_regdomain rwnx_regdom_cz = {
	.country_code = "CZ",
	.prRegdRules = &regdom_cz_nl
};

struct rwnx_regdomain rwnx_regdom_jp = {
	.country_code = "JP",
	.prRegdRules = &regdom_jp
};

struct rwnx_regdomain rwnx_regdom_tr = {
	.country_code = "TR",
	.prRegdRules = &regdom_tr
};

struct rwnx_regdomain *g_prRegRuleTable[] = {
	&rwnx_regdom_00,
	/*&rwnx_regdom_us01,*/
	&rwnx_regdom_us,
	&rwnx_regdom_cn,
...
struct ieee80211_regdomain *getRegdomainFromRwnxDB(char *alpha2)
{
	u8 idx;
	//struct rwnx_regdomain *prRegd;
...
// registration (in rwnx_set_wiphy_params()), so nothing has to be done here
    ...
    rtnl_lock();
    if (regulatory_set_wiphy_regd_sync_rtnl(wiphy, getRegdomainFromRwnxDB(default_ccode))){
