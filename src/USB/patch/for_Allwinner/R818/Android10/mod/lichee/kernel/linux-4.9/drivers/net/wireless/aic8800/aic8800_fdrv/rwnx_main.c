                                               ...
                                               struct vif_params *params)
{
	...
	printk("rwnx_hw->wiphy->perm_addr:%x %x %x %x %x %x\n", rwnx_hw->wiphy->perm_addr[0], rwnx_hw->wiphy->perm_addr[1], \
        rwnx_hw->wiphy->perm_addr[2], rwnx_hw->wiphy->perm_addr[3], rwnx_hw->wiphy->perm_addr[4], rwnx_hw->wiphy->perm_addr[5]);
